        ...
        <section className="bg-gray-50 py-16 sm:py-20" aria-labelledby="featured-journeys-title">
            <div className="container mx-auto px-4 sm:px-6">
                <div className="text-center mb-12 sm:mb-16">
                    <h2 id="featured-journeys-title" className="text-3xl sm:text-4xl font-bold text-primary-800 mb-4">Featured Journeys</h2>
                ...
                <div className="text-center mt-12 sm:mt-16">
                    <Link
                        to="/tours"
                        className="inline-block bg-primary-500 hover:bg-primary-600 text-white font-bold py-3.5 px-8 rounded-lg text-base sm:text-lg transition-colors duration-300 shadow-md hover:shadow-lg"
