...
const WhyChooseUs: React.FC = () => {
    // Icon components
    const ToursIcon = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-[#83bf48]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    ...
    return (
        <section className="bg-[#1f2b38] py-16 sm:py-20 relative overflow-hidden" aria-labelledby="why-choose-us">
            {/* Background decorative elements */}
            <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-[#83bf48] to-transparent"></div>
            <div className="absolute -top-24 -right-24 w-48 h-48 rounded-full bg-[#83bf48]/10 blur-xl"></div>
            <div className="absolute -bottom-24 -left-24 w-48 h-48 rounded-full bg-[#83bf48]/5 blur-xl"></div>
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10">
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    <h2 id="why-choose-us" className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 mt-2">
                        The Everest Miracle <span className="text-[#83bf48]">Experience</span>
                    </h2>
                    <div className="w-24 h-1 bg-linear-to-r from-[#83bf48] to-transparent mx-auto mb-6"></div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="group relative bg-white/5 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-white/10 hover:border-[#83bf48]/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#83bf48]/10"
                        >
                            {/* Hover effect background */}
                            <div className="absolute inset-0 bg-linear-to-br from-[#83bf48]/5 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                            <div className="relative z-10">
                                <div className="flex justify-center items-center mb-4 sm:mb-6">
                                    <div className="bg-white/10 p-3 sm:p-4 rounded-2xl group-hover:bg-[#83bf48]/10 transition-colors duration-300 group-hover:scale-110 transform">
                                        {feature.icon}
                                    </div>
                                </div>
                                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 text-center group-hover:text-[#83bf48] transition-colors duration-300">
                                    {feature.title}
                                </h3>
                            ...
                            {/* Number indicator */}
                            <div className="absolute -top-2 -right-2 w-8 h-8 bg-[#83bf48] rounded-full flex items-center justify-center text-white text-xs font-bold">
                                {index + 1}
                            </div>
                        </div>
                    ))}
                ...
                <div className="mt-12 sm:mt-16 text-center">
                    <div className="bg-linear-to-r from-[#83bf48]/10 to-[#1a2336]/50 p-8 rounded-2xl border border-[#83bf48]/20 max-w-4xl mx-auto">
                        <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4">
                            Ready for Your <span className="text-[#83bf48]">Adventure</span>?
                        </h3>
                        <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                            Join thousands of satisfied travelers who have experienced the magic of Nepal with us.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <button className="px-8 py-3 bg-[#83bf48] text-white font-semibold rounded-lg hover:bg-[#73a940] transition-colors duration-300 transform hover:scale-105 shadow-lg shadow-[#83bf48]/20">
                                Book Your Trip Now
                            </button>
