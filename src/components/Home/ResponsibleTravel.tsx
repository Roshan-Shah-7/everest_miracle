...
const ResponsibleTravel: React.FC = () => {
    ...
    return (
        <section className="bg-gray-50 py-20 relative overflow-hidden">
            ...
            <div className="absolute -top-32 -right-32 w-64 h-64 rounded-full bg-logo-green/10 blur-3xl"></div>
            <div className="absolute -bottom-32 -left-32 w-64 h-64 rounded-full bg-logo-green/10 blur-3xl"></div>
            ...
            <div className="container mx-auto px-6 relative z-10">
                    ...
                    <div className="order-2 lg:order-1">
                        <div className="mb-6">
                            ...
                            <h2 className="text-4xl font-bold text-gray-900 mb-6">
                                A Commitment to <span className="text-logo-green">Responsible Travel</span>
                            </h2>
                            <div className="w-20 h-1 bg-linear-to-r from-logo-green to-transparent mb-6"></div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                            {initiatives.map((initiative, index) => (
                                <div key={index} className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm hover:shadow-md hover:border-logo-green/30 transition-all duration-300">
                    ...
                    <div className="order-1 lg:order-2">
                        <div className="relative group">
                            ...
                            <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur-sm p-4 rounded-xl border border-white shadow-lg">
                                ...
                                <div className="font-bold text-logo-green">Since 2008</div>
                ...
                {/* Call to Action */}
                <div className="mt-16 text-center bg-linear-to-r from-logo-green/10 to-white p-8 rounded-2xl border border-logo-green/20 shadow-sm">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">
                        Join Us in Making a <span className="text-logo-green">Positive Impact</span>
                    </h3>
